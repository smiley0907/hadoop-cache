...
//    manipulateNCache(8, 9);
    ...
    public static void manipulateNCache(int cacheSize, int numFiles) throws URISyntaxException, IOException
    {
        System.out.println("----------------" + cacheSize + " Cache. "+ numFiles +" Files ------------------------");
        
        System.out.println("Time before program start : " + getDate());
        
        System.out.println("Main class to test TestAddCache");

        Cache job = new NSetCache(cacheSize * 16);

        List<URI> uris = new ArrayList<URI>();
        
        for (int i = 1; i <= numFiles; i++) {
            String fileName = "C:/purna/indir/myFile" + i + ".txt";
